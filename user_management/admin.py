...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = [
        ...
        ("Personal info", {"fields": ["first_name", "last_name", "username", "email", "date_of_birth", "profile_picture"]}),
        ("Permissions", {"fields": ["access_code", "is_active", "is_staff", "is_superuser", 'groups', 'user_permissions']}),
    ]
    add_fieldsets = [
        (
            None,
